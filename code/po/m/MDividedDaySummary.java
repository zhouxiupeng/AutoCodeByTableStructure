...
/**
 * 【分成汇总记录表】持久化对象 数据库表：m_divided_day_summary
 * 
 * @author 代码自动生成 113857118@qq.com 
 * @date 2018-04
 * 
 */
public class MDividedDaySummaryVO implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("MDividedDaySummaryVO");
   ...
   /* public boolean equals(Object obj) {
        ...
        if (obj instanceof MDividedDaySummaryVO) {
            MDividedDaySummaryVO mDividedDaySummary = (MDividedDaySummaryVO) obj;
            if (this.getId().equals(mDividedDaySummary.getId())) {
                return true;
            }
        }
        return false;
