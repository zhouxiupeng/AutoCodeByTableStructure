...
/**
 * 【管理团队每天的统计】持久化对象 数据库表：m_team_daily_reports
 * 
 * @author 代码自动生成 113857118@qq.com 
 * @date 2018-04
 * 
 */
public class MTeamDailyReportsVO implements Serializable {
   ...
   /* public boolean equals(Object obj) {
        ...
        if (obj instanceof MTeamDailyReportsVO) {
            MTeamDailyReportsVO mTeamDailyReports = (MTeamDailyReportsVO) obj;
            if (this.getMuid().equals(mTeamDailyReports.getMuid()) && this.getArchivingTime().equals(mTeamDailyReports.getArchivingTime())) {
                return true;
            }
        }
        return false;
