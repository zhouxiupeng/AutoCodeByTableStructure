...
/**
 * 【管理团队每天维持的统计】持久化对象 数据库表：m_team_keep_daily_reports
 * 
 * @author 代码自动生成 113857118@qq.com 
 * @date 2018-04
 * 
 */
public class MTeamKeepDailyReportsVO implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("MTeamKeepDailyReportsVO");
   ...
   /* public boolean equals(Object obj) {
        ...
        if (obj instanceof MTeamKeepDailyReportsVO) {
            MTeamKeepDailyReportsVO mTeamKeepDailyReports = (MTeamKeepDailyReportsVO) obj;
            if (this.getMuid().equals(mTeamKeepDailyReports.getMuid()) && this.getArchivingTime().equals(mTeamKeepDailyReports.getArchivingTime())) {
                return true;
            }
        }
        return false;
