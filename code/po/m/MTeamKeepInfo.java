...
/**
 * 【当前考核周期内团队维持的总体数据】持久化对象 数据库表：m_team_keep_info
 * 
 * @author 代码自动生成 113857118@qq.com 
 * @date 2018-05
 * 
 */
public class MTeamKeepInfoVO implements Serializable {
   ...
   /* public boolean equals(Object obj) {
        ...
        if (obj instanceof MTeamKeepInfoVO) {
            MTeamKeepInfoVO mTeamKeepInfo = (MTeamKeepInfoVO) obj;
            if (this.getMuid().equals(mTeamKeepInfo.getMuid())) {
                return true;
            }
        }
        return false;
