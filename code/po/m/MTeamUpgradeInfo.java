...
/**
 * 【当前考核周期内团队升级的总体数据】持久化对象 数据库表：m_team_upgrade_info
 * 
 * @author 代码自动生成 113857118@qq.com 
 * @date 2018-04
 * 
 */
public class MTeamUpgradeInfoVO implements Serializable {
    ...
    // 总成员数
    private Integer totalMembersNumber;
    // 数据归档时间
    ...
    /** 获取 总成员数 */
    public Integer getTotalMembersNumber() {
        return totalMembersNumber;
    }

    /** 设置 总成员数 */
    public void setTotalMembersNumber(Integer totalMembersNumber) {
    ...
    public String toString() {
        ...
        sb.append(", totalMembersNumber=").append(totalMembersNumber);
   ...
   /* public boolean equals(Object obj) {
        ...
        if (obj instanceof MTeamUpgradeInfoVO) {
            MTeamUpgradeInfoVO mTeamUpgradeInfo = (MTeamUpgradeInfoVO) obj;
            if (this.getMuid().equals(mTeamUpgradeInfo.getMuid())) {
                return true;
            }
        }
        return false;
