...
/**
 * 【管理团队每月的统计, 维持数据】持久化对象 数据库表：m_team_upgrade_monthly_reports
 * 
 * @author 代码自动生成 113857118@qq.com 
 * @date 2018-05
 * 
 */
public class MTeamUpgradeMonthlyReportsVO implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("MTeamUpgradeMonthlyReportsVO");
   ...
   /* public boolean equals(Object obj) {
        ...
        if (obj instanceof MTeamUpgradeMonthlyReportsVO) {
            MTeamUpgradeMonthlyReportsVO mTeamUpgradeMonthlyReports = (MTeamUpgradeMonthlyReportsVO) obj;
            if (this.getMuid().equals(mTeamUpgradeMonthlyReports.getMuid()) && this.getArchivingTime().equals(mTeamUpgradeMonthlyReports.getArchivingTime())) {
                return true;
            }
        }
        return false;
