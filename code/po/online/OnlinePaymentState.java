...
/**
 * 【待查询支付状态的订单列表】持久化对象 数据库表：online_payment_state
 * 
 * @author 代码自动生成 113857118@qq.com 
 * @date 2018-03
 * 
 */
public class OnlinePaymentStateVO implements Serializable {
    ...
    public String toString() {
        ...
        sb.append("OnlinePaymentStateVO");
   ...
   /* public boolean equals(Object obj) {
        ...
        if (obj instanceof OnlinePaymentStateVO) {
            OnlinePaymentStateVO onlinePaymentState = (OnlinePaymentStateVO) obj;
            if (this.getOrderId().equals(onlinePaymentState.getOrderId())) {
                return true;
            }
        }
        return false;
